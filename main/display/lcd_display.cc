...
void LcdDisplay::SetupUI() {
    ...
    emotion_label_ = lv_image_create(screen);
    lv_obj_set_size(emotion_label_, width_ , height_);
    ...
    lv_obj_set_size(status_bar_, LV_HOR_RES, fonts_.text_font->line_height *1.5);
    lv_obj_set_style_bg_color(status_bar_, current_theme_.background, 0);
    lv_obj_set_style_pad_top(status_bar_, 100, 0);
    ...
    lv_obj_set_style_pad_top(chat_message_label_, 90, 0);
    lv_obj_move_background(chat_message_label_ );
...
void LcdDisplay::SetEmotionImg(const lv_image_dsc_t *img){
    ...
    int screen_diameter = 240;
    lv_obj_set_size(emotion_label_, screen_diameter, screen_diameter);
    lv_obj_set_style_radius(emotion_label_, LV_RADIUS_CIRCLE, 0);
    lv_obj_set_style_clip_corner(emotion_label_, true, 0); 
    
    lv_img_set_src(emotion_label_, img);
    lv_img_set_zoom(emotion_label_, 260);
    lv_obj_center(emotion_label_);
    lv_obj_align(emotion_label_, LV_ALIGN_CENTER, 0, -1);
    lv_obj_clear_flag(emotion_label_, LV_OBJ_FLAG_HIDDEN);
    }
