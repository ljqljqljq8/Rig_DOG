...
void Application::Start() {
    ...
    xTaskCreatePinnedToCore([](void* arg) {
        ...
        app->XgoTask();
        vTaskDelete(NULL);
    }, "xgo_task", 4096, this, 1, &xgo_task_handle_, 0);
    ...
    if (XGO_UART_RX_PIN != GPIO_NUM_NC) {
        xTaskCreatePinnedToCore([](void* arg) {
            ...
            app->XgoRxTask();
            vTaskDelete(NULL);
        }, "xgo_rx_task", 4096, this, 1, &xgo_rx_task_handle_, 1);
    } else {
        ESP_LOGI(TAG, "Skipping XGO RX task because servo feedback RX is disabled");
    }
#endif
