...
#define DISPLAY_USE_GC9A01_CUSTOM_INIT 0

#define XGO_UART_TX_PIN       GPIO_NUM_3
// GPIO38 is already used for the LCD backlight on Lulu, so keep servo RX disabled
// until a verified non-conflicting feedback pin is confirmed from hardware.
#define XGO_UART_RX_PIN       GPIO_NUM_NC
